...
public class ActionsUtility {
	...
	public void hoverOnElement(WebElement element) {
		action.pause(3000).moveToElement(element).perform();
	}

	public void selectAndDeleteValue(WebElement element) {
		action.click(element).keyDown(Keys.CONTROL).sendKeys("a").keyDown(Keys.DELETE).perform();
	}
