...
public class TestCase02 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(RelativeLocator.with(By.name("password"))).sendKeys("admin123");
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		if (driver.getCurrentUrl().contains(expectedUrlPart)) {
			System.out.println("Refresh successful and URL validated");
		}
